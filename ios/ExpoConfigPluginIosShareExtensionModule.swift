...
public class ExpoConfigPluginIosShareExtensionModule: Module {
  ...
  public func definition() -> ModuleDefinition {
    ...
    // The module will be accessible from `requireNativeModule('ExpoConfigPluginIosShareExtension')` in JavaScript.
    Name("ExpoConfigPluginIosShareExtension")
    ...
    AsyncFunction("getSharedInfo") { (url: String) in
